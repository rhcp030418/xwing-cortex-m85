...
def main():
    ...
    for idx, name in ((0, "keccak-f1600"), (1, "x25519-scalarmult"),
                      ...
                      (193, "expac-ab-baseline-keygen"),
                      (194, "expac-ab-baseline-encaps"),
                      (195, "expac-ab-baseline-decaps"),
                      (196, "expac-ab-candidate-keygen"),
                      (197, "expac-ab-candidate-encaps"),
                      (198, "expac-ab-candidate-decaps"),
                      (199, "expac-ba-candidate-keygen"),
                      (200, "expac-ba-candidate-encaps"),
                      (201, "expac-ba-candidate-decaps"),
                      (202, "expac-ba-baseline-keygen"),
                      (203, "expac-ba-baseline-encaps"),
                      (204, "expac-ba-baseline-decaps"),
                      (205, "expad-sx-ab-scalar-keygen"),
                      (206, "expad-sx-ab-scalar-encaps"),
                      (207, "expad-sx-ab-scalar-decaps"),
                      (208, "expad-sx-ab-x4-keygen"),
                      (209, "expad-sx-ab-x4-encaps"),
                      (210, "expad-sx-ab-x4-decaps"),
                      (211, "expad-sx-ba-x4-keygen"),
                      (212, "expad-sx-ba-x4-encaps"),
                      (213, "expad-sx-ba-x4-decaps"),
                      (214, "expad-sx-ba-scalar-keygen"),
                      (215, "expad-sx-ba-scalar-encaps"),
                      (216, "expad-sx-ba-scalar-decaps"),
                      (217, "expae-fu-ab-fiat-keygen"),
                      (218, "expae-fu-ab-fiat-encaps"),
                      (219, "expae-fu-ab-fiat-decaps"),
                      (220, "expae-fu-ab-u-keygen"),
                      (221, "expae-fu-ab-u-encaps"),
                      (222, "expae-fu-ab-u-decaps"),
                      (223, "expae-fu-ba-u-keygen"),
                      (224, "expae-fu-ba-u-encaps"),
                      (225, "expae-fu-ba-u-decaps"),
                      (226, "expae-fu-ba-fiat-keygen"),
                      (227, "expae-fu-ba-fiat-encaps"),
                      (228, "expae-fu-ba-fiat-decaps"),
                      (229, "expaf-u4-ab-seq"),
                      (230, "expaf-u4-ab-fused"),
                      (231, "expaf-u4-ba-fused"),
                      (232, "expaf-u4-ba-seq"),
                      (233, "expaf-u8-ab-seq"),
                      (234, "expaf-u8-ab-fused"),
                      (235, "expaf-u8-ba-fused"),
                      (236, "expaf-u8-ba-seq")):
    ...
    ai_names = (
        "expai-fu-ab-f-total", "expai-fu-ab-f-fused", "expai-fu-ab-f-residual",
        "expai-fu-ab-u-total", "expai-fu-ab-u-fused", "expai-fu-ab-u-residual",
        "expai-fu-ba-u-total", "expai-fu-ba-u-fused", "expai-fu-ba-u-residual",
        "expai-fu-ba-f-total", "expai-fu-ba-f-fused", "expai-fu-ba-f-residual",
        "expai-fu1-ab-f-total", "expai-fu1-ab-f-fused", "expai-fu1-ab-f-residual",
        "expai-fu1-ab-u1-total", "expai-fu1-ab-u1-fused", "expai-fu1-ab-u1-residual",
        "expai-fu1-ba-u1-total", "expai-fu1-ba-u1-fused", "expai-fu1-ba-u1-residual",
        "expai-fu1-ba-f-total", "expai-fu1-ba-f-fused", "expai-fu1-ba-f-residual",
    )
    for idx, name in enumerate(ai_names, start=237):
        vals = sorted(reps[idx * REP_N:(idx + 1) * REP_N])
        med = vals[REP_N // 2]
        meds[name] = med
        print(f"[N={REP_N}] {name}: checkpoint-median={med} min={vals[0]} max={vals[-1]}")

    aj_names = (
        "expaj-mlkem-a1-keygen", "expaj-mlkem-a1-encaps", "expaj-mlkem-a1-decaps",
        "expaj-mlkem-b1-keygen", "expaj-mlkem-b1-encaps", "expaj-mlkem-b1-decaps",
        "expaj-mlkem-b2-keygen", "expaj-mlkem-b2-encaps", "expaj-mlkem-b2-decaps",
        "expaj-mlkem-a2-keygen", "expaj-mlkem-a2-encaps", "expaj-mlkem-a2-decaps",
        "expaj-xwing-a1-keygen", "expaj-xwing-a1-encaps", "expaj-xwing-a1-decaps",
        "expaj-xwing-b1-keygen", "expaj-xwing-b1-encaps", "expaj-xwing-b1-decaps",
        "expaj-xwing-b2-keygen", "expaj-xwing-b2-encaps", "expaj-xwing-b2-decaps",
        "expaj-xwing-a2-keygen", "expaj-xwing-a2-encaps", "expaj-xwing-a2-decaps",
    )
    for idx, name in enumerate(aj_names, start=261):
        vals = sorted(reps[idx * REP_N:(idx + 1) * REP_N])
        med = vals[REP_N // 2]
        meds[name] = med - calib
        print(f"[N={REP_N}] {name}: median={med} (calib {calib} 차감시 {med - calib})"
    ...
    ak_names = (
        "expak-mlkem-v1a-keygen", "expak-mlkem-v1a-encaps", "expak-mlkem-v1a-decaps",
        "expak-mlkem-v2a-keygen", "expak-mlkem-v2a-encaps", "expak-mlkem-v2a-decaps",
        "expak-mlkem-v2b-keygen", "expak-mlkem-v2b-encaps", "expak-mlkem-v2b-decaps",
        "expak-mlkem-v1b-keygen", "expak-mlkem-v1b-encaps", "expak-mlkem-v1b-decaps",
        "expak-xwing-v1a-keygen", "expak-xwing-v1a-encaps", "expak-xwing-v1a-decaps",
        "expak-xwing-v2a-keygen", "expak-xwing-v2a-encaps", "expak-xwing-v2a-decaps",
        "expak-xwing-v2b-keygen", "expak-xwing-v2b-encaps", "expak-xwing-v2b-decaps",
        "expak-xwing-v1b-keygen", "expak-xwing-v1b-encaps", "expak-xwing-v1b-decaps",
    )
    for idx, name in enumerate(ak_names, start=285):
        vals = sorted(reps[idx * REP_N:(idx + 1) * REP_N])
        med = vals[REP_N // 2]
        meds[name] = med - calib
        print(f"[N={REP_N}] {name}: median={med} (calib {calib} 차감시 {med - calib})"
    ...
    al_names = (
        "expal-mlkem-a1-keygen", "expal-mlkem-a1-encaps", "expal-mlkem-a1-decaps",
        "expal-mlkem-b1-keygen", "expal-mlkem-b1-encaps", "expal-mlkem-b1-decaps",
        "expal-mlkem-b2-keygen", "expal-mlkem-b2-encaps", "expal-mlkem-b2-decaps",
        "expal-mlkem-a2-keygen", "expal-mlkem-a2-encaps", "expal-mlkem-a2-decaps",
        "expal-xwing-a1-keygen", "expal-xwing-a1-encaps", "expal-xwing-a1-decaps",
        "expal-xwing-b1-keygen", "expal-xwing-b1-encaps", "expal-xwing-b1-decaps",
        "expal-xwing-b2-keygen", "expal-xwing-b2-encaps", "expal-xwing-b2-decaps",
        "expal-xwing-a2-keygen", "expal-xwing-a2-encaps", "expal-xwing-a2-decaps",
    )
    for idx, name in enumerate(al_names, start=309):
        vals = sorted(reps[idx * REP_N:(idx + 1) * REP_N])
        med = vals[REP_N // 2]
        meds[name] = med - calib
        print(f"[N={REP_N}] {name}: median={med} (calib {calib} 차감시 {med - calib})"
    ...
    expac_kat = re.search(r"expAE x4-kat-fails: (\d+) u-kat-fails=(\d+)", log)
    expac_eq = re.search(r"expAE bytes-mm: (\d+) smoke-fails=(\d+)", log)
    expac_timing = re.search(
        r"expAE timing-mm: (\d+) stack-fails=(\d+) stack-used=(\d+)", log)
    expac_ab = {
        op: (meds.get(f"expac-ab-baseline-{op}"), meds.get(f"expac-ab-candidate-{op}"))
        for op in ("keygen", "encaps", "decaps")
    }
    expac_ba = {
        op: (meds.get(f"expac-ba-baseline-{op}"), meds.get(f"expac-ba-candidate-{op}"))
        for op in ("keygen", "encaps", "decaps")
    }
    print("\n[exp AE] true Fiat yield1+b1 + Keccak-f1600x4 X-Wing ABBA")
    if expac_kat and expac_eq and expac_timing:
        print(f"  primitive KAT: x4={expac_kat.group(1)}, U={expac_kat.group(2)}")
        print(f"  end-to-end: byte-mm={expac_eq.group(1)}, smoke={expac_eq.group(2)}, "
              f"timing-mm={expac_timing.group(1)}, stack-fails={expac_timing.group(2)}, "
              f"stack-highwater={expac_timing.group(3)} B")
        gate = all(value == "0" for value in (
            expac_kat.group(1), expac_kat.group(2), expac_eq.group(1),
            expac_eq.group(2), expac_timing.group(1), expac_timing.group(2)))
        for op in ("keygen", "encaps", "decaps"):
            base_ab, cand_ab = expac_ab[op]
            base_ba, cand_ba = expac_ba[op]
            if None in (base_ab, cand_ab, base_ba, cand_ba):
                continue
            save_ab = base_ab - cand_ab
            save_ba = base_ba - cand_ba
            conservative = min(save_ab, save_ba)
            pct = conservative / max(base_ab, base_ba) * 100
            print(f"  {op}: AB {base_ab}->{cand_ab} ({save_ab:+} cyc), "
                  f"BA {base_ba}->{cand_ba} ({save_ba:+} cyc), "
                  f"conservative {conservative:+} cyc ({pct:+.2f}%)")
        print("  correctness gate: " + ("PASS" if gate else "FAIL"))
    else:
        print("  exp AE log fields missing")

    print("\n[exp AE attribution]")
    for op in ("keygen", "encaps", "decaps"):
        a1 = meds.get(f"expad-sx-ab-scalar-{op}")
        b1 = meds.get(f"expad-sx-ab-x4-{op}")
        b2 = meds.get(f"expad-sx-ba-x4-{op}")
        a2 = meds.get(f"expad-sx-ba-scalar-{op}")
        if None not in (a1, b1, b2, a2):
            d1, d2 = a1 - b1, a2 - b2
            conservative = min(d1, d2)
            pct = conservative / max(a1, a2) * 100
            print(f"  x4 batching (S->X) {op}: AB {a1}->{b1} ({d1:+} cyc), "
                  f"BA {a2}->{b2} ({d2:+} cyc), "
                  f"conservative {conservative:+} cyc ({pct:+.2f}%)")

        a1 = meds.get(f"expae-fu-ab-fiat-{op}")
        b1 = meds.get(f"expae-fu-ab-u-{op}")
        b2 = meds.get(f"expae-fu-ba-u-{op}")
        a2 = meds.get(f"expae-fu-ba-fiat-{op}")
        if None not in (a1, b1, b2, a2):
            d1, d2 = a1 - b1, a2 - b2
            conservative = min(d1, d2)
            pct = conservative / max(a1, a2) * 100
            print(f"  true U (F->U) {op}: AB {a1}->{b1} ({d1:+} cyc), "
                  f"BA {a2}->{b2} ({d2:+} cyc), "
                  f"conservative {conservative:+} cyc ({pct:+.2f}%)")

    s4a, f4a = meds.get("expaf-u4-ab-seq"), meds.get("expaf-u4-ab-fused")
    f4b, s4b = meds.get("expaf-u4-ba-fused"), meds.get("expaf-u4-ba-seq")
    s8a, f8a = meds.get("expaf-u8-ab-seq"), meds.get("expaf-u8-ab-fused")
    f8b, s8b = meds.get("expaf-u8-ba-fused"), meds.get("expaf-u8-ba-seq")
    if None not in (s4a, f4a, f4b, s4b, s8a, f8a, f8b, s8b):
        p4a, p4b = f4a - s4a, f4b - s4b
        p8a, p8b = f8a - s8a, f8b - s8b
        print("\n[exp AF] identical-work U4/U8 batch attribution")
        print(f"  U4: AB seq={s4a} fused={f4a} P4={p4a:+}; "
              f"BA seq={s4b} fused={f4b} P4={p4b:+}")
        print(f"  U8: AB seq={s8a} fused={f8a} P8={p8a:+}; "
              f"BA seq={s8b} fused={f8b} P8={p8b:+}")
        print(f"  U8-specific P8-2*P4: AB={p8a - 2 * p4a:+}, "
              f"BA={p8b - 2 * p4b:+} cycles per 24-round batch")

    print("\n[exp AI] encaps F/U/U1 interval attribution (raw checkpoint medians)")
    for tag, candidate in (("F->U", "u"), ("F->U1", "u1")):
        stem = "expai-fu" if candidate == "u" else "expai-fu1"
        ab = {}
        ba = {}
        for metric in ("total", "fused", "residual"):
            ab[metric] = meds[f"{stem}-ab-{candidate}-{metric}"] - meds[f"{stem}-ab-f-{metric}"]
            ba[metric] = meds[f"{stem}-ba-{candidate}-{metric}"] - meds[f"{stem}-ba-f-{metric}"]
        ab_other = ab["total"] - ab["fused"] - ab["residual"]
        ba_other = ba["total"] - ba["fused"] - ba["residual"]
        print(f"  {tag}: AB total={ab['total']:+} fused={ab['fused']:+} residual={ab['residual']:+} other={ab_other:+}; "
              f"BA total={ba['total']:+} fused={ba['fused']:+} residual={ba['residual']:+} other={ba_other:+}")
    u_fused = (meds["expai-fu-ab-u-fused"] + meds["expai-fu-ba-u-fused"]) / 2
    u1_fused = (meds["expai-fu1-ab-u1-fused"] + meds["expai-fu1-ba-u1-fused"]) / 2
    print(f"  2-job fused-path delta U-U1={u_fused - u1_fused:+.1f} cycles")
