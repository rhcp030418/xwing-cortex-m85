...
#define k32_mode 0u
#else
extern volatile uint32_t k32_mode;
#endif
    ...
    uint32_t r)
{
  ...
  {
    KeccakF1600_StatePermute(s);
    if (k32_mode) KeccakF1600_StateExtractLanes_bk(s, h, r >> 3);
