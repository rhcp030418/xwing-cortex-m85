...
// expc_seq: counter=[r12,#376]
.global expc_seq
.type expc_seq, %function
.thumb_func
.balign 16
expc_seq:
	push {r4-r11, lr}
...
// expc_slothy: counter=[r12,#376]
.global expc_slothy
.type expc_slothy, %function
.thumb_func
.balign 16
expc_slothy:
	push {r4-r11, lr}
...
1:
	...
	adc r1, r1, r10, lsr     #26
	bic r3, r9, #0xFE000000
	lsr r9, r9, #25
	orr r10, r9, r1, lsl     #7
	ldr r9, [r12, #292]
	adds r10, r9, r10
	bic r7, r0, #0xFC000000
	adc r1, r14, r1, lsr     #25
	ldr r0, [r12, #4]
	str r3, [r0, #12]
	lsr r14, r10, #26
	orr r14, r14, r1, lsl     #6
	ldr r3, [r12, #256]
	adds r14, r3, r14
	ldr r9, [r12, #252]
	adc r9, r9, r1, lsr     #26
	...
	adc r9, r6, r9, lsr     #26
	lsr r14, r1, #25
	orr r14, r14, r9, lsl     #7
	ldr r6, [r12, #288]
	adds r14, r6, r14
	str r3, [r0, #24]
	adc r3, r2, r9, lsr     #25
	bic r6, r1, #0xFE000000
	lsr r1, r14, #26
	orr r9, r1, r3, lsl     #6
	ldr r1, [r12, #296]
	...
	adc r5, r6, #0
	lsrs r3, r2, #26
	bic r7, r10, #0xFC000000
	bic r2, r2, #0xFC000000
	orr r1, r3, r5, lsl     #6
	str r2, [r0, #0]
	add r10, r11, r1
	str r7, [r0, #16]
	bic r3, r10, #0xFE000000
	ldr r11, [r8, #0]
	add r4, r4, r10, lsr     #25
	str r3, [r0, #4]
	str r4, [r0, #8]
	ldr r9, [r8, #40]
	eor r6, r11, r9
	...
	lsl r7, r10, #1
	ldr r6, [r8, #400]
	orr r9, r7, r11, lsr     #31
	ldr r7, [r8, #416]
	eor r6, r9, r6
	lsl r11, r11, #1
	str r6, [r8, #448]
	ldr r10, [r8, #404]
	orr r11, r11, r7, lsr     #31
	ldr r7, [r8, #424]
	eor r9, r11, r10
	ldr r6, [r8, #428]
	str r9, [r8, #452]
	...
	lsl r6, r9, #1
	ldr r7, [r8, #416]
	orr r9, r6, r10, lsr     #31
	ldr r6, [r8, #432]
	eor r7, r9, r7
	lsl r10, r10, #1
	ldr r9, [r8, #400]
	orr r10, r10, r6, lsr       #31
	ldr r6, [r8, #420]
	lsl r11, r9, #1
	str r7, [r8, #464]
	ldr r7, [r8, #404]
	...
	str r7, [r8, #332]
	ldr r7, [r8, #80]
	orr r10, r9, r10, lsr     #28
	ldr r9, [r8, #84]
	eor r7, r7, r11
	eor r9, r9, r6
	str r10, [r8, #328]
	lsl r10, r7, #3
	orr r10, r10, r9, lsr     #29
	lsl r9, r9, #3
	orr r9, r9, r7, lsr     #29
	str r10, [r8, #256]
	str r9, [r8, #260]
	...
	str r9, [r8, #360]
	lsl r9, r10, #6
	orr r9, r9, r11, lsr     #26
	lsl r11, r11, #6
	str r9, [r8, #288]
	ldr r9, [r8, #96]
	orr r10, r11, r10, lsr     #26
	ldr r11, [r8, #100]
	eor r11, r11, r7
	eor r9, r9, r6
	str r10, [r8, #292]
	lsl r10, r9, #11
	orr r10, r10, r11, lsr     #21
	lsl r11, r11, #11
	str r10, [r8, #220]
	ldr r10, [r8, #140]
	...
	orr r11, r11, r9, lsr     #17
	lsl r9, r9, #15
	orr r10, r9, r10, lsr     #17
	str r11, [r8, #344]
	lsl r9, r7, #29
	str r10, [r8, #348]
	lsl r11, r6, #29
	ldr r10, [r8, #28]
	orr r11, r11, r7, lsr     #3
	ldr r7, [r8, #468]
	orr r9, r9, r6, lsr     #3
	ldr r6, [r8, #464]
	str r11, [r8, #276]
	...
	str r10, [r8, #296]
	lsl r10, r11, #21
	orr r10, r10, r9, lsr     #11
	lsl r9, r9, #21
	orr r9, r9, r11, lsr     #11
	ldr r11, [r8, #188]
	eor r7, r11, r7
	ldr r11, [r8, #184]
	eor r11, r11, r6
	...
	str r9, [r8, #308]
	lsl r9, r7, #14
	orr r10, r11, r7, lsr     #18
	orr r11, r9, r6, lsr       #18
	ldr r9, [r8, #208]
	str r11, [r8, #236]
	ldr r11, [r8, #216]
	ldr r6, [r8, #200]
