...
def self_test():
    assert SLOT_N == 717 and FIRST_SLOT == BASE == 570
    print("self-test OK")
...
def main():
    ...
    ca1a = C <= A * 1.05
    ca1b = C < A + Bv * 0.5
    print("    CA-1a  C <= A x 1.05 (%8.2f) = %s" % (A * 1.05, "PASS" if ca1a else "FAIL"))
    print("    CA-1b  C <  A + B/2  (%8.2f) = %s" % (A + Bv * 0.5, "PASS" if ca1b else "FAIL"))
