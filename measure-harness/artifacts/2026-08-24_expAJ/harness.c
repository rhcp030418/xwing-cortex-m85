...
static uint8_t dtcm_stack[16384] __attribute__((aligned(8), section(".dtcm")));   /* ML-KEM m4fspeed ?ㅽ깮 ??KB */
...
void harness_main(void)
{
    ...
    uart_puts("rep arrays ready x100 (285 slots)\n");
