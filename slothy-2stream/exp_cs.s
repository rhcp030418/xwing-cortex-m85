// 실험 CS: 실제 U 조각 fiat_mul_u4_p0 본문 — 솔버 입력
// 원본 592 명령 -> 변환 후 606 (ldrd 9, strd 5 분해)
// 스칼라 453 / 벡터 153, 스필 프레임 232B
start:
	mov	r12, #38
	vldrw.u32 q0, [r11, #0xFFFFFE04]
	mov	r14, r2
	ldr	r3, [r2, #4]
	vldrw.u32 q1, [r11, #0xFFFFFE54]
	ldr	r7, [r2, #32]
	ldr	r4, [r2, #8]
	ldr	r2, [r2, #12]
	veor q0, q0, q1
