...
def fig01() -> Scene:
    ...
    scene_title(
        s,
        "Where the eight retained transformations act",
    ...
    box(s, lane_x + mm(45), ml_y, mm(23), mm(9), "[2] 11 MVE data transforms", BLUE_LIGHT, BLUE, 5.6, max_chars=18)
...
def fig02() -> Scene:
    ...
    scene_title(
        ...
        "Intermediate percentages remain diagnostic; the headline comes from one Reference-Integrated comparison",
    )
    y = mm(18)
    xs = [4, 27, 51, 76, 101]
    ...
    labels = [
        ...
        ("Reference / Integrated", "final headline"),
    ]
    colors = [
        (GRAY_100, GRAY_500),
        (BLUE_LIGHT, BLUE),
...
def fig03() -> Scene:
    ...
    scene_title(
        ...
        "The retained encapsulation path replaces two expensive inversions with one zero-safe inversion",
    )
    s.text(mm(30), mm(16), "Baseline: independent conversions", 6.8, RED, True, "center")
    ...
    s.text(mm(92), mm(16), "Retained: zero-safe paired inversion", 6.8, GREEN, True, "center")
